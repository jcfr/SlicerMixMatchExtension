...
class ScriptedMixMatch(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "ScriptedMixMatch" # TODO make this more human readable by adding spaces
...
class ScriptedMixMatchWidget(ScriptedLoadableModuleWidget):
  ...
  def onApplyButton(self):
    logic = ScriptedMixMatchLogic()
    enableScreenshotsFlag = self.enableScreenshotsFlagCheckBox.checked
    imageThreshold = self.imageThresholdSliderWidget.value
    logic.run(self.inputSelector.currentNode(), self.outputSelector.currentNode(), imageThreshold, enableScreenshotsFlag)

#
# ScriptedMixMatchLogic
#

class ScriptedMixMatchLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('ScriptedMixMatchTest-Start','MyScreenshot',-1)
...
class ScriptedMixMatchTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_ScriptedMixMatch1()

  def test_ScriptedMixMatch1(self):
